...
/**
 * Test script to verify simplified OCR configuration works
 */

const BASE_URL = 'http://localhost:3000';

async function testSimplifiedOCR() {
  console.log('🧪 Testing Simplified OCR Configuration...\n');

  try {
    // Test with a simple image
    const testImageBase64 = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkYPhfDwAChwGA60e6kgAAAABJRU5ErkJggg==';
    
    console.log('1️⃣ Testing simplified OCR configuration...');
    ...
    console.log('📊 Simplified OCR Test Result:', {
    ...
    if (result.result && !result.error) {
      console.log('\n🎉 Simplified OCR Configuration Successful!');
    ...
    if (osdErrors === 0 && psmErrors === 0 && runtimeErrors === 0) {
      console.log('🎉 Simplified OCR stability test passed!');
    } else {
