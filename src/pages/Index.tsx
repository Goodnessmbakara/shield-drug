...
const Index = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Full compliance with Nigeria's Mobile Authentication Service",
      color: "text-danger"
    }
  ];
      ...
      <section className="py-20 text-center">
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            ...
            compliant with NAFDAC regulations and EU Falsified Medicines Directive.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button onClick={() => navigate('/login')} variant="hero" size="xl">
              Get Started
      ...
      <section className="py-20 bg-card/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">Advanced Anti-Counterfeit Technology</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Combining blockchain immutability, AI analysis, and regulatory compliance 
              to protect Nigeria's pharmaceutical supply chain.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground">
              Tailored interfaces for manufacturers, pharmacists, consumers, and regulators
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {userTypes.map((type, index) => (
              <Card key={index} className="shadow-soft hover:shadow-medium transition-all cursor-pointer group">
                <CardHeader className="text-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center gap-2 mb-4 md:mb-0">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">Securing Nigeria's pharmaceutical supply chain</p>
              </div>
            </div>
