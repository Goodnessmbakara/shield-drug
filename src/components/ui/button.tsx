  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-hero text-white hover:shadow-glow shadow-medium font-semibold",
        scan: "bg-gradient-primary text-white hover:shadow-glow shadow-medium font-semibold scale-105 hover:scale-110 transition-transform",
      },
      size: {
        default: "h-10 px-4 py-2",
        sm: "h-12 md:h-9 px-4 md:px-3 text-base md:text-sm",
        touch: "h-12 px-4 py-3 text-base min-h-touch min-w-touch",
